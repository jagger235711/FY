        ...
        $(function () {
            ...
            $("#delete").click(function () {
                ...
                if (checkedBoxs.length < 1) {
                    $.ligerDialog.error("请选择一个需要删除的新闻！");
                } else {
                    /** 得到公告选中的所有的需要删除的ids */
                    ...
                    $.ligerDialog.confirm("确认要删除吗?", "删除新闻", function (r) {
                        if (r) {
                            // alert("删除："+ids.get());
                            // 发送请求
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：新闻管理 &gt; 新闻查询</td>
                    ...
                    <td class="fftd">
                        <form name="noticeform" method="post" id="noticeform" action="${ctx}/notice/selectNotice">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">
                                        新闻名称：<input type="text" name="title">
