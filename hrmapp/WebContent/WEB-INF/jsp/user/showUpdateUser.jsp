                        ...
                        <td class="font3 fftd">
                            <table>
                                <tr>
                                    ...
                                    <td class="font3 fftd">状态：<input type="text" name="status" id="status" size="20"
                                                                     value="${user.status }"/></td>
                                </tr>

                                <tr>
                                    <td class="font3 fftd">登录名：<input name="loginname" id="loginname" size="20"
