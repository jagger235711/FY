...
<div style="margin:10px;background-color:#FFFFFF; text-align:left;">
    <table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
        ...
        <tr valign="top">
            <td class="left_nav_bgshw" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="user/selectUser" target="main">用户查询</a></img></p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
        ...
        <%--            <td class="left_nav_bgshw" height="50">--%>
        <%--                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a--%>
        <%--                        href="dept/selectDept" target="main">部门查询</a></img></p>--%>
        <%--                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a--%>
        <%--                        href="dept/addDept?flag=1" target="main">添加部门</a></img></p>--%>
        <%--            </td>--%>
        <%--        </tr>--%>
        <%--        <tr>--%>
        <%--            <td height="2"></td>--%>
        ...
        <%--            <td class="left_nav_bgshw" height="50">--%>
        <%--                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="job/selectJob"--%>
        <%--                                                                                                    target="main">职位查询</a></img>--%>
        <%--                </p>--%>
        <%--                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a--%>
        <%--                        href="job/addJob?flag=1" target="main">添加职位</a></img></p>--%>
        <%--            </td>--%>
        <%--        </tr>--%>
        <%--        <tr>--%>
        <%--            <td height="2"></td>--%>
        ...
        <%--            <td class="left_nav_bgshw" height="50">--%>
        <%--                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a--%>
        <%--                        href="${ctx }/employee/selectEmployee" target="main">员工查询</a></img></p>--%>
        <%--                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a--%>
        <%--                        href="${ctx }/employee/addEmployee?flag=1" target="main">添加员工</a></img></p>--%>
        <%--            </td>--%>
        <%--        </tr>--%>
        <%--        <tr>--%>
        <%--            <td height="2"></td>--%>
        ...
        <tr>
            <td id="navbg4" class="left_nav_closed">
                <div class="font1">新闻管理</div>
            </td>
        </tr>
        <tr valign="top" id="submenu4" style="display: none">
            <td class="left_nav_bgshw tdbtmline" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/notice/selectNotice" target="main">新闻查询</a></img></p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/notice/addNotice?flag=1" target="main">添加新闻</a></img></p>
            </td>
        </tr>
        <tr>
            <td height="2"></td>
        ...
        <tr valign="top" id="submenu5" style="display: none">
            <td class="left_nav_bgshw tdbtmline" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/document/selectDocument" target="main">文档查询</a></img></p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/document/addDocument?flag=1" target="main">上传文档</a></img></p>
            </td>
        </tr>
        <tr>
            <td height="2"></td>
        ...
        <tr>
            <td id="navbg6" class="left_nav_closed">
                <div class="font1">非遗管理</div>
            </td>
        </tr>
        <tr valign="top" id="submenu6" style="display: none">
            <td class="left_nav_bgshw tdbtmline" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/fy/selectFy" target="main">非遗查询</a></img></p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/fy/addFy?flag=1" target="main">添加非遗</a></img></p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/fy/examineFy" target="main">非遗审查</a></img></p>
            </td>
        </tr>
        <tr>
            <td height="2"></td>
