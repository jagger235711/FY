                        ...
                        <td class="font3 fftd">
                            <table>
                                <tr>
                                    ...
                                    <td class="font3 fftd">身份证号码：<input type="text" name="cardId" id="cardId" size="20"
                                ...
                                <tr>
                                    <td class="font3 fftd">学历：<input name="education" id="education" size="20"
                                ...
                                <tr>
                                    <td class="font3 fftd">手机：<input name="phone" id="phone" size="20"
