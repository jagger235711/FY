    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        _applyEditor: function (obj) {
            ...
            var row = $(rowcell).parent(), rowdata = g.getRow(row[0]), rowid = rowdata['__id'],
                rowindex = rowdata['__index'];
...
(function ($) {
    ...
    $.ligerui.controls.ListBox.ligerExtend($.ligerui.controls.Input, {
        ...
        selectAll: function () {
            ...
            $("tr", g.selectBox).addClass("l-selected").find(":checkbox").each(function () {
                this.checked = true;
            });
    ...
    $.ligerui.controls.PopupEdit.ligerExtend($.ligerui.controls.Input, {
        ...
        addValue: function (value, text) {
            ...
            if (!v) {
                ...
                var arrV = [], arrT = [], old = v.split(p.split), value = value.split(p.split),
...
(function ($) {
    ...
    $.ligerui.controls.Portal.ligerExtend($.ligerui.core.UIComponent, {
        ...
        add: function (e) {
            ...
            var gColumn = g.rows[rowIndex].columns[columnIndex], pColumn = p.rows[rowIndex].columns[columnIndex],
                ligerPanel, jcolumn = $(gColumn.element);
...
(function ($) {
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        addTabItem: function (options) {
            ...
            var tabid = options.tabid;
            if (tabid == undefined) tabid = g.getNewTabid();
            var url = options.url, content = options.content, text = options.text, showClose = options.showClose,
