<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"  %>
<%--isELIgnored="false"--%>
<%--isELIgnored是EL表达式是否显示的关键字，默认为true，el表达式失效或不能不显示--%>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="https://github.com/supermermer"
				style="font-size: 22px; color: #FFF;"> 非遗管理<span style="color: #FFCC00; ">Fym</span><span
		...
		<form action="login" method="post" id="loginForm">
			<div class="page-body">
				<img class="page-lock-img"
					src="${ctx}/js/metronic/img/profile/logo2.png" alt="">
				<div class="page-lock-info">
					<span style="padding-top: 5px">允许以中文名称登录</span>
					<c:choose>
						<c:when test="${requestScope.message == null }">
							<span style="padding-top: 5px">请登录！</span>
						</c:when>
						<c:otherwise>
							<span style="padding-top: 5px"><span style="color: red; ">${requestScope.message}</span></span>
						</c:otherwise>
					</c:choose>
